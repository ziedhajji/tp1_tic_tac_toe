...
function Xgagne() {
    ...
    if ((c4 == c5) && (c5 == c6) && (c6 == "X" || c6 == "O")) {
        if (c6 == "X") etat = 1;
        else  etat = 2;
    }
    if ((c7 == c8) && (c8 == c9) && (c9 == "X" || c9 == "O")) {
        if (c9 == "X")   etat = 1;
        else  etat = 2;
    }
    if ((c1 == c4) && (c4 == c7) && (c7 == "X" || c7 == "O")) {
        if (c7 == "X") etat = 1;
        else  etat = 2;
    }
    if ((c2 == c5) && (c5 == c8) && (c8 == "X" || c8 == "O")) {
        if (c8 == "X") etat = 1;
        else  etat = 2;
    }
    if ((c3 == c6) && (c6 == c9) && (c9 == "X" || c9 == "O")) {
        if (c9 == "X") etat = 1;
        else  etat = 2;
    }
    if ((c1 == c5) && (c5 == c9) && (c9 == "X" || c9 == "O")) {
        if (c9 == "X") etat = 1;
        else  etat = 2;
    }
    if ((c3 == c5) && (c5 == c9) && (c7 == "X"|| c7 == "O")) {
        if (c7 == "X") etat = 1;
        else  etat = 2;
    }
    ...
    if (etat == 1)
    {
        ...
        gagne.setAttribute("class", "jeuxTicTac2");
    }
    else if(etat==2)
    {
...
/*reste a determiner en cas d'egalité l'image correspondante
* supprimé la fonction onclick en cas ou l'un des deux joueurs gagne*/
